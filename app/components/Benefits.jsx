  ...
  return (
    <main className="w-full h-full max-w-[1440px] mx-auto  py-20">
      <section className="h-full w-full  rounded-md px-4 md:px-10 flex flex-col gap-10 ">
        ...
        <p className="text-xs sm:text-lg">All my packages comes with an e-commerce option availible</p></div>
        ...
        <p className="text-xs sm:text-lg">for only 1999kr/month you gain acces to my hosting software, collect all leads in one place, and build automated sales funnels</p></div>
        </div>
      </section>
    </main>
  )
